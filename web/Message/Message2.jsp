                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="/images/lzn.jpg" alt="user" class="rounded-circle"> <span class="ml-1 pro-user-name">${USER_SESSION.getUsername()} <i class="mdi mdi-chevron-down"></i> </span>
                            </a>
            ...
            <div class="row mt-4">
                ...
                <div class="col-4">
                    ...
                    <div class="card-box" id="contact-frame">
                        ...
                        <h4 class="header-title m-b-30">消息列表 </h4>

                        <div class="contacts-list" id="contact-box" style="overflow-y: scroll;">

                            <!-- 缺少联系人逻辑 添加、删除等-->

                            <c:forEach items="${USER_SESSION.getContactList()}" var="contactItem" begin="0"
                                       end="${USER_SESSION.getContactList().size()}" step="1" varStatus="status">
                                <div class="media m-b-20 contacts ">

                                    <div class="d-flex mr-3">

                                        <a href="#" onclick=""> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../images/lzn.jpg"> </a>

                                    </div>

                                    <div class="media-body">

                                        <h5 class="mt-0"><c:out value="${contactItem}"/></h5>
                    ...
                    <div class="card-box task-detail" id="message-frame" style="position: relative;">
                        ...
                        <div class="media mt-0 m-b-30" style="border-bottom: 1px solid black;padding-bottom: 1rem;">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="media-heading mb-0 mt-0">${currentContact}</h5>
